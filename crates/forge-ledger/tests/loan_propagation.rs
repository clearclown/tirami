...
use forge_core::{LayerRange, ModelId, NodeId, WorkUnit};
use forge_ledger::{
...
/// Local stand-in for `forge_proto::messages::LoanGossip`. Field-identical to
...
fn loan_propagates_from_one_ledger_to_another() {
    ...
    assert_eq!(loans_b[0].loan.principal_cu, WELCOME_LOAN_AMOUNT);
