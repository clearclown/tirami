use forge_core::{Config, ForgeError, ModelManifest, NodeId, PeerCapability, PipelineTopology};
...
) -> Result<TopologySnapshot, ForgeError> {
...
mod tests {
    ...
    use forge_core::{Config, ModelId, ModelManifest, NodeId};
