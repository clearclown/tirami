use forge_core::{LayerRange, ModelManifest, PeerCapability, PipelineStage, PipelineTopology};
...
impl ShardAssigner {
    ...
    ) -> Result<PipelineTopology, forge_core::ForgeError> {
        if peers.is_empty() {
            return Err(forge_core::ForgeError::ShardAssignmentError(
